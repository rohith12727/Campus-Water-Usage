...
def user_suggestions(user_data: WaterUsage) -> str:
    ...
    if compare <= 60:
        ...
        return "Good start on conservation, but you should still reduce your water usage by being more conscious of how long you spend showering and using the sink."
    else:
